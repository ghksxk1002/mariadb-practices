...
select a.emp_no as '사번', a.first_name as '이름', salary as '연봉'
...
select a.emp_no as '사번', concat(a.first_name,' ',a.last_name) as '이름',  b.title as '직책', c.dept_name as '부서'
...
select a.last_name as '이름', d.dept_name as '부서명', b.title as '직책'
  from employees a, titles b, departments d, dept_emp c
 where a.emp_no = b.emp_no
...
select c.first_name as '이름', b.salary as '급여'
...
-- 현재, 부서별 평균 연봉을 연봉이 큰 부서 순서대로 출력하세요.
  select c.dept_name as '부서명', a.salary as '평균 연봉'
