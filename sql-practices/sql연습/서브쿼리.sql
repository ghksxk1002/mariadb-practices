...
-- 2-2) where 절의 서브 쿼리 : 복수행 연산자(in, not in, any, all)
...
-- all
-- 1. =all 이런경우는 말이 안됨 사용할수 없음
-- 2. >all >=all : 최댓값
-- 3. <all, <=all : 최솟값

-- 실습문제3 : 현제 급여가 50000 이상인 직원의 이름을 출력하세요
-- 대혁 50001
-- 둘리 50200
...
-- 실습문제4 : 현제 각 부서 별로 최고 월급을 받는 직원의 이름과 월급 출력
-- 대혁 50001
-- 둘리 50200
...
select d.dept_no, c.first_name, b.salary
